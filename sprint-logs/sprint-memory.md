...
## 반복 패턴 & 주의사항
- 이슈 생성 전 기존 구현 여부를 반드시 확인할 것 (스프린트 20에서 #170, #171, 스프린트 31에서 #176, 스프린트 47에서 #221이 이미 구현되어 있었음)
...
## 최근 3개 스프린트 요약
### Sprint 47 (2026-03-09)
- 완료: PR #220 머지 (docs: sprint-46 조회수순 정렬 반영), 이슈 #221 닫힘 (기존 구현 확인), 테스트 303개 전체 통과 (회귀 없음)
- 발견된 문제: 이슈 #221(카탈로그 영상 삭제 기능)이 이미 구현 완료 상태 — Developer/Tester 스킵, 새 릴리스 없음
